...
@section('title', 'Assignment - Variables, Operators, Data Types')

@section('custom_head')
    @include('homework.css.firstWorkCss')
@endsection
...
@section('content')
    ...
    <section class="practice-div">
        <div class="input-section">
            <label for="is_num">Input number</label>
            <input type="number" id="is_num">
    ...
    @include('homework.javascript.firstWorkJs')
@endsection
