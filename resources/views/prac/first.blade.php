...
@section('title', 'JavaScript (Very) Basic')

@section('custom_head')
    @include('prac.css.app')
    @include('prac.javascript.firstJs')
@endsection
    ...
    <main>
        ...
        <section id="about-the-instructor">
            ...
            <div id="instructor-info">
                <img src="{{ asset('images/max.jpg') }}" alt="Image of Maximilian Schwarzmüller - the course instructor" />
                <ul>
